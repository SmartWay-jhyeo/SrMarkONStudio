...
static const MkLcdCmd INIT_CMDS[] = {
    ...
    /* 36h MADCTL — p.192 §5.2.30. MY·MX·MV·ML·BGR·MH 전부 0.
     * 리셋 기본값도 00h 지만(p.194 Default 표) 명시해 둔다 — 나중에
     * 하드웨어 리셋 없이 다시 초기화해도 같은 방향으로 서게 하려는 것이다. */
    { 0x36u, 1u, { 0x00u, 0u, 0u, 0u }, 0u },
