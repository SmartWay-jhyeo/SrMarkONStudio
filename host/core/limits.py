...
#
# 🔴 [개정 2026-08-31, HANDOFF_0831 결정 2] 직렬화기가 mk_cloud 하나가
#    되면서 상한도 그쪽 것이다: 모든 송신부가 `char body[MK_CLOUD_LINE_MAX]`
#    (512) 에 줄을 짓고 `len + 2 > cap` 이면 **통째로 버린다**(반쪽 JSON 을
#    내보내지 않는 정책, finish_and_emit) — 즉 JSON 은 510 바이트까지만
#    나간다. (mk_telem 시절에는 MK_LINE_MAX+6 = 198 이었다.)
#
...
MK_CLOUD_LINE_MAX = 512
TELEM_RECORD_JSON_MAX = MK_CLOUD_LINE_MAX - 2
