...
PLAN = [
    ...
    # 🔴 [2026-08-31 저녁] 온습도는 **J10** — 새(2호) 보드의 I2C5 버스
    #    (J12/J13)가 하드웨어 불량이다(냉납 의심): 센서·케이블은 J10 에서
    #    정상, J12/J13 은 재장착·전원재투입 무효. VCC(JP2) 3.3V 는 정상
    #    실측. 수리 전까지 J10(I2C3) 운용.
    ("i2c10.kind",     "2",        "J10 AM2320 온습도 (J12/J13 버스 불량 우회)"),
    ("i2c10.addr",     "92",       "0x5C"),
    ("i2c10.enabled",  "true",     ""),
    ("i2c10.name",     "온습도",    ""),
